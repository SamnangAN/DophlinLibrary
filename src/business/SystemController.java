...
public class SystemController implements ControllerInterface {
	...
	public List<Book> searchBook(String isbn, String title) {
		...
		return bookMap.values().stream().filter(book -> filterBooks(book, isbn, title)).collect(Collectors.toList());
	}
	...
	public CheckoutRecordEntry checkoutBook(String memberId, String isbn) throws LibrarySystemException {
		...
		CheckoutRecordEntry cr = member.checkout(book.getNextAvailableCopy(), LocalDate.now(),
